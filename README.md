# Playwright automation - train ticket booking

### How to
- Clone the repository
    - `git clone https://github.com/MaheshMadushan/AutomatedTrainTicketBooking.git && cd <cloned dir>/AutomatedTrainTicketBooking`
